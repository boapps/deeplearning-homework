            ...
            if filename.endswith(".xml"):
                ...
                with open(xml_file_path, "r") as xml_file:
                    try:
                        ...
                        xml_dict = order_dict(
                            xmltodict.parse(xml_file.read())["annotation"]
                        )
                        # force objects to be a list
                        xml_dict["object"] = (
                            xml_dict["object"]
                            if type(xml_dict["object"]) == list
                            else [xml_dict["object"]]
                        )
                        # flatten objects
                        ...
                        # fix types
                        xml_dict["segmented"] = (
                            True if xml_dict["segmented"] == "1" else False
                        )
                        ...
                        # fix objects
                        xml_dict["object"] = [
                            process_object(object) for object in xml_dict["object"]
                        ]
